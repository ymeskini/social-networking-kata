...
describe('DateProvider', () => {
  ...
  describe('formatRelative', () => {
    ...
    it('should return "1 minute ago" when the message was published 1 minute ago', async () => {
      const now = new Date('2021-01-01T16:31:00Z');
    ...
    it('should return "X minutes ago" when the message was published more than 2 minutes ago', async () => {
      const now = new Date('2021-01-01T16:31:00Z');
